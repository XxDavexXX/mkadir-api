...
class User(AbstractUser):
    ...
    paternal_surname = models.CharField(max_length=255,default=None, blank=True, null=True)
    maternal_surname = models.CharField(max_length=255,default=None, blank=True, null=True)
